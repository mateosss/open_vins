...
#define VIT_HEADER_VERSION_MAJOR 3 //!< API Breakages
...
/*!
 * Set of extensions. Index of array matches enumerators in @ref vit_tracker_extension.
 */
typedef struct vit_tracker_extension_set {
	bool has[VIT_TRACKER_EXTENSION_COUNT];
